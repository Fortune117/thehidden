...
SWEP.Primary.Delay 		= 0.3 //Delay between shots.
...
SWEP.CrossHairDeltaDistance = 5 // The distance the crosshair rests at while standing.
...
SWEP.KickMove = 0.1 // The divide amount for our movement.
SWEP.MaxMoveKick = 30
