...
GM.Hidden.PounceCost = 25 // How much stamina it takes to pounc. Default: 25.
...
GM.Hidden.BodyHealAmount = 15 // How much health the Hidden gets for hitting a body. Default: 15.
